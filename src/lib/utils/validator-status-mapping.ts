/**
 * Maps Beacon Chain validator status to user-friendly status
 * Based on the status mapping table from the requirements
 */
...
/**
 * Maps beacon chain status to user-friendly status
 */
